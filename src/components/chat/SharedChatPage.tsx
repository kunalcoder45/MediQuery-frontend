...
export function SharedChatPage({ chatId }: SharedChatPageProps) {
    ...
    const fetchSharedChat = async () => {
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_CHAT_API_BASE_URL}/api/chat/shared/${chatId}`
        );
  ...
  return <ChatInterface sharedMessages={messages} />;
}
